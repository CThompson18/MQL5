...
//*********************************************************************
//---- input parameters
extern double glbRisk = 11.00;
extern int glbCountBars = 1000;
...
//*********************************************************************
extern int glb_right_edge_shift = 1600;
						...
						if (Table_value2[shift + i1] < x2) 
							{
								...
								dblBid = Low[shift] - Range * 0.5;
								DataDisplay(dblBid,"Buy");
							}
					}      
			shift--;
...
//void DataDisplay()
   {
		...
		text= "Account Total = "+DoubleToString(dblAccount ,5);
		...
		text= "LotSize = "+DoubleToString(dblLotSize ,5);
		...
		text = "***************************************************";
		createObject(17,OBJ_LABEL,0,xAxis,yAxis + glb_upper_edge_shift * 17,text);

		text= "Bid = "+DoubleToString(dblBid ,5);
		createObject(18,OBJ_LABEL,0,xAxis,yAxis + glb_upper_edge_shift * 18,text);										
   }

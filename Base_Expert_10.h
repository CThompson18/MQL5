...
void PlaceOrders()
   {   
      ...
      for (cnt = 0 ; cnt <=intOrders ; cnt++)
		...
		if(glbTicket == 0){if (intTicket != 0){glbTicket = intTicket;}}
		
      if(intTicket == 0){if (glbAsk > glbCurrent){Order_Ask();}}
      if(intTicket == 0){if (glbBid < glbCurrent){Order_Bid();}}
      
      if(glbTicket != 0){if (intAskBid == 2){if(glbBid != 0){CloseAll();Order_Bid();}}}
      if(glbTicket != 0){if (intAskBid == 1){if(glbAsk != 0){CloseAll();Order_Ask();}}}

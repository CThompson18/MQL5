...
color r1_p=LightGray;
color r1_r2=LightGray;
color r2_r3=LightGray;
color s1_p=LightGray;
color s1_s2=LightGray;
color s2_s3=LightGray;
...
double rates[10][6],yesterday_close,yesterday_high,yesterday_low;
...
TMA(tma,TMA_Periods,TMA_ApplyTo);

...
void DataDisplay()
   {
		...
		text= "Ask DateTime = "+TimeToString(glbAskDateTime ,TIME_DATE|TIME_MINUTES);
		...
		text= "Bid DateTime = "+TimeToString(glbBidDateTime ,TIME_DATE|TIME_MINUTES);
